...
const arcond = require.context(
  "../images/img-services/arcond",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const drywall = require.context(
  "../images/img-services/drywall",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const eletrica = require.context(
  "../images/img-services/eletrica",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const hidraulica = require.context(
  "../images/img-services/hidraulica",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const manutencao = require.context(
  "../images/img-services/manutencao",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const pintura = require.context(
  "../images/img-services/pintura",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
const remodelacao = require.context(
  "../images/img-services/remodelacao",
  true,
  /\.(png|jpg|jpeg|gif|svg|webp)$/
);
...
const services = [
  {
    ...
    title: "Adesivação",
    resumo:
      "Plotagem de adesivo é uma película adesiva em vinil impressa com imagens em dimensões ampliadas, normalmente fabricada em PVC.",
  ...
  },
  {
    ...
    resumo:
      "A letra caixa também conhecida por letra 3D ou letra em alto relevo proporciona destaque a sua marca, deixando seu estabelecimento em evidência. ",
  ...
  },
  {
    ...
    resumo:
      "Possibilita fachadas mais evidentes e personalizados com a marca do cliente. ",
  ...
  },
  {
    ...
    resumo:
      " O totem é ideal para compor fachadas de estabelecimentos e empresas, pois atraem maior atenção de potenciais clientes",
  ...
  },
  {
    ...
    resumo:
      "As fachadas de telha galvanizada aliam resistência, durabilidade e um visual ímpar a fachada do seu negócio.",
  ...
  },
  {
    ...
    icon: icon_arcond,
    cover: capa_arcond,
    title: "Referência em Toldos e Placas",
    resumo: "Equipe Profissional com mais de 20 anos de experiência",
    text: "Fale com um especialista e tire todas suas dúvidas :)",
    servicos: ["Há mais de 30 anos sendo Líder e Referência no mercado!"],
    images: arcond,
  },
];
